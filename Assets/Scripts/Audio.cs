...
public class Audio : MonoBehaviour
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        //private Controller m_Controller; // Reference to car we are controlling
        ...
        {
            // get the Controller ( this will not be null as we have require component)
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_Controller.engineRPM / m_Controller.maxRPM);
                ...
                else
                {
                    ...
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_Controller.engineRPM / m_Controller.maxRPM);
                    float lowFade = 1 - accFade;
